...
const sidebars = {
  docsSidebar: [
      ...
      items: [
        {
          ...
          items: [
            ...
            'migration/splunk/logstash',
            'migration/splunk/fluentd',
          ],
        },
        {
          type: 'category',
          ...
          items: [
            ...
            'migration/elasticsearch/logstash',
            'migration/elasticsearch/fluentd',
          ],
        },
        {
          type: 'category',
        ...
        },
        {
          ...
          items: [
            ...
            'migration/awscloudwatch/fluentd',
          ],
        },
        {
          type: 'category',
    ...
    {
      type: 'category',
      label: 'Grafana Integrations',
      items: ['grafana-integrations/prometheus-data-source'],
    },
    'splunk-apis',
    'promql-apis',
    'siglens-metrics',
